...
{
	NOT_IN_CENTER(SpineWare.messagesBundle.getString("bad_posture_not_in_center")),
	TOO_CLOSE(SpineWare.messagesBundle.getString("bad_posture_too_close")),
	MULTIPLE_FACES(SpineWare.messagesBundle.getString("too_many_faces")),
	USER_IS_AWAY(SpineWare.messagesBundle.getString("user_is_away"));
