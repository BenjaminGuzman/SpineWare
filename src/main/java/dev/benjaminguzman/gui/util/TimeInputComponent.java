...
public class TimeInputComponent extends JPanel
{
	...
	public boolean checkInputValidity()
	{
		...
		if (selected_value <= 5) {
			...
			this.warningLabel.setText(SpineWare.messagesBundle.getString("must_be_greater_than"));
			return false;
		}
			...
			if (selected_value > max_recommended_value)
				this.warningLabel.setText(
					this.maxRecommendedTime.getHMSAsString()
						+ " " + SpineWare.messagesBundle.getString("is_the_maximum")
				);
			else if (selected_value < min_recommended_value)
				this.warningLabel.setText(
					this.minRecommendedTime.getHMSAsString()
						+ " " + SpineWare.messagesBundle.getString("is_the_minimum")
				);
			else {
				clearWarning();
	...
	public void showRecommendedValueWarning(boolean show_upper_bound)
	{
		...
		this.warningLabel.setText(wallClock.getHMSAsString() + " " + SpineWare.messagesBundle.getString("is_recommended"));
	}
