...
package dev.benjaminguzman.gui.util;
...
public class NotificationLocationComponent extends JPanel
{
	...
	)
	{
		...
		String[] locationOptions = new String[]{
			SpineWare.messagesBundle.getString("notification_location_bottom_right"),
			SpineWare.messagesBundle.getString("notification_location_bottom_left"),
			SpineWare.messagesBundle.getString("notification_location_top_right"),
			SpineWare.messagesBundle.getString("notification_location_top_left")
		};
		...
		this.add(new JLabel(SpineWare.messagesBundle.getString("notification_location")), gbc);
