...
public class CamMarginsPanel extends JPanel implements Initializable
{
	...
	{
		JLabel titleLabel = new JLabel(SpineWare.messagesBundle.getString("cam_margin_title"));
		titleLabel.setFont(Fonts.TITLE_FONT);

		JLabel descLabel = new JLabel(SpineWare.messagesBundle.getString("cam_margin_description"));
	...
	private JPanel createMarginSliderPanel(boolean is_X)
	{
		...
		panel.add(new JLabel(SpineWare.messagesBundle.getString(is_X ? "cam_margin_x" : "cam_margin_y")));
		panel.add(slider);
