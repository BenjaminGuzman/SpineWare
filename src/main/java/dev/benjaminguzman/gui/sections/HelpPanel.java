...
public class HelpPanel extends AbstractSection
{
	...
	public void initComponents()
	{
		...
		try (InputStream inputStreamGPLLogo = SpineWare.getFileAsStream("/resources/media/gplv3-136x68.png")) {
		...
		moreEditorPane.setText(SpineWare.messagesBundle.getString("help_text"));
			...
			if (Desktop.isDesktopSupported()) {
				try {
					...
					JOptionPane.showMessageDialog(
						null,
						SpineWare.messagesBundle.getString("error_couldnt_open_browser"),
						"Error",
